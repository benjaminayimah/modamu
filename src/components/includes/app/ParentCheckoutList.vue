...
<div>
    ...
    <button v-if="attendee.status != '3'" @click.prevent="doChecking" class="button-primary w-100 gap-8" :class="{ 'check-out' : attendee.status == '2'}">
        ...
        {{ attendee.status == '0' ? 'Check in' : 'Check out' }}
    </button>
    <div v-else class="flx gap-8">
        <button @click.prevent="" class="button-primary button-disabled w-100 gap-8" disabled="true">
        ...
        <button @click="$store.dispatch('deleteAttendee', attendee.id)" class="del-btn">
