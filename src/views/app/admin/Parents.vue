    ...
    <section class="section-main">
        <div class="title-row flx gap-50 ai-c">
            ...
            <div class="input-wrapper">
                ...
                <input class="form-control" v-model="search" type="search" data-type="icon" placeholder="Search parents...">
            </div>
        </div>
        <div id="grid_table">
            ...
            <div v-else-if="computedItem.length" class="grid table-body">
                ...
                <parent-row v-for="parent in computedItem" :key="parent.id" :parent="parent" />
            </div>
    ...
    computed: {
        ...
        computedItem() {
            ...
            return this.parents.filter(item => {
                return item.name.toLowerCase().match(this.search.toLowerCase()) || item.relationship.toLowerCase().match(this.search.toLowerCase())
            })
            else
            return this.parents
        }
