<template>
    <section class="section-main" v-if="is_super">
        <div class="title-row2 flx gap-50 ai-c jc-sb">
        ...
        <div class="empty-state flx jc-c ai-c" v-if="!sub_admins.length">
            <div class="pd-32 br-16 bg-white add-container">
                <div class="text-center">Select who you would like to add</div>
                    ...
                    <ul class="flx br-32">
                        <li>
                            <router-link :to="{ name: 'SubAdminViewOne' }" class="flx gap-8 ai-c">
                                Sub admins
                                <span v-if="device !== 'mobile'" class="br-16">{{ getSubAdmins.length }}</span>
                            </router-link>
                        </li>
                        <li>
                            <router-link :to="{ name: 'SubAdminViewTwo' }" class="flx gap-8 ai-c">
                                Village personnels
                                <span v-if="device !== 'mobile'" class="br-16">{{ getVillagePersonnels.length }}</span>
                            </router-link>
                        </li>
                    </ul>
                </nav>
