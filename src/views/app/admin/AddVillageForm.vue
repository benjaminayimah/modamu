            ...
            <form @submit.prevent="submitSignUp" class="flx column gap-24">
                ...
                <div class="form-col">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input autocomplete="off" class="form-control" type="search" data-color="dark" data-type="icon" ref="address" placeholder="Start typing, then pick from the dropdown list">
                    </div>
...
export default {
    ...
    name: 'AddVillageForm',
    mixins: [tempImageUploadMixin, passwordToggleMixin, inputValMixin, autoCompleMixin],
    computed: {
