            ...
            <form @submit.prevent="" class="flx column gap-24">
                ...
                <div class="form-row column">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input v-model="form.phone_number" @input="formatPhoneNumber" class="form-control" type="tel" name="phone" id="phone" data-type="icon" data-color="dark" placeholder="222-333-4444">
                    </div>
...
export default {
    ...
    name: 'AddVillageForm',
    mixins: [tempImageUploadMixin, passwordToggleMixin, inputValMixin, autoCompleMixin, phoneNumberMixin],
    computed: {
