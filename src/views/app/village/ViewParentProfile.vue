    ...
    <section>
        ...
        <div class="flx gap-50">
            <div class="main-content-card account-card relative flx column gap-24">
                <a @click.prevent="$store.commit('openModal', 'edit-profile')" href="#" class="absolute edit-btn ft-primary a-btn gap-8 flx">
                ...
                <div class="flx ai-c column gap-16">
                    <profile-avatar :image="getUser.image"  :id="getUser.id"/>
                    <h4>{{ getUser.name }}</h4>
                    <span class="acc-type br-32">{{ computedAcc }}</span>
                </div>
                <div class="flx column gap-16">
                    ...
                    <div class="flx jc-sb br-16 info-row ai-c">
                        ...
                        <span>{{ getUser.emergency_number || 'n/a' }}</span>
                    </div>
                    <div class="flx jc-sb br-16 info-row ai-c">
                        <div class="flx gap-8">
                            <svg xmlns="http://www.w3.org/2000/svg" height="18" viewBox="0 0 19.616 19.782">
                        ...
                        <span>{{ getUser.ocupation || 'n/a' }}</span>
                    </div>
                    <div class="flx jc-sb br-16 info-row ai-c">
                        <div class="flx gap-8">
                    ...
                    <div>
                        ...
                        <div class="forgot-pass">
                            <a @click.prevent="$store.commit('openModal', 'change-pass')" href="#" class="a-btn ft-primary">Change password</a>
                        </div>
                    </div>
                    <button class="del-btn">Delete account</button>
                </div>
            </div>
            <div class="right flx-grow-1 mt--32">
                ...
                <div class="flx gap-50">
                    <div class="kids-column flx column gap-16">
                        ...
                        <kids-list :noClick="true" v-for="kid in getKids" :key="kid.id" :kid="kid" :id="getUser.id"/>
                    </div>
                </div>
            </div>
...
export default {
  components: { ProfileAvatar, KidsList },
    ...
    computed: {
        ...mapGetters(['getUser', 'getHostname', 'getDefaultImage', 'getKids']),
        ...mapState({
