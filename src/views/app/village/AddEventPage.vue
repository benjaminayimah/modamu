                        ...
                        <div>
                            <button id="location_preloaded" class="gap-8 br-24">
                                <div class="flx gap-8 ai-c">
                                    ...
                                    <span class="gray">{{ user.address }}</span>
                                </div>
                            </button>
                        </div>
                    </div>
                </div>
                <form @submit.prevent="" class="flx column gap-24" id="add_event_form">
                    <div class="grid col-2 gap-16">
                        <div class="form-col">
                            <label for="event_name">Event name*</label>
                            <div class="input-wrapper">
                                <i>
                                    <svg xmlns="http://www.w3.org/2000/svg" height="18" viewBox="0 0 20.743 20.776">
                    ...
                    <div class="grid col-2 gap-16">
                        <div class="form-col">
                            ...
                            <div class="input-wrapper">
                                <i>
                                    <svg xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 0 21 36">
                                        <path d="M-3369.149-537.562v-4.5h-7.5a1.5,1.5,0,0,1-1.5-1.5,1.5,1.5,0,0,1,1.5-1.5h7.5v-7.5h-2.25a6.757,6.757,0,0,1-6.75-6.75,6.758,6.758,0,0,1,6.75-6.75h2.25v-4.5a1.5,1.5,0,0,1,1.5-1.5,1.5,1.5,0,0,1,1.5,1.5v4.5h6a1.5,1.5,0,0,1,1.5,1.5,1.5,1.5,0,0,1-1.5,1.5h-6v7.5h2.25a6.758,6.758,0,0,1,6.75,6.75,6.757,6.757,0,0,1-6.75,6.75h-2.25v4.5a1.5,1.5,0,0,1-1.5,1.5A1.5,1.5,0,0,1-3369.149-537.562Zm5.25-7.5a3.754,3.754,0,0,0,3.75-3.75,3.755,3.755,0,0,0-3.75-3.75h-2.25v7.5Zm-11.25-14.251a3.754,3.754,0,0,0,3.75,3.75h2.25v-7.5h-2.25A3.754,3.754,0,0,0-3375.149-559.312Z" transform="translate(3378.149 572.062)"/>
                                    </svg>
                                </i>
                        ...
                        <div class="form-col">
                            ...
                            <div class="input-wrapper">
                                <i>
                                    <svg xmlns="http://www.w3.org/2000/svg" height="18" viewBox="0 0 17.75 21.584">
                    ...
                    <div class="form-row column">
                        ...
                        <div class="input-wrapper">
                            <textarea v-model="form.description" class="form-control" name="description" id="description" rows="4" data-color="dark" placeholder="A brief description about your event"></textarea>
                        </div>
