        ...
        <div class="flx gap-16 column mt-32">
            <div class="track-event-list flx column gap-24 bg-white br-24">
                ...
                <div class="relative img-stacks">
                    <div v-for="kid in attendees.slice(0, 5)" :key="kid.id" class="bg-img attendees br-50"></div>
                ...
                <div class="flx jc-sb gap-8">
                    <div>
                        ...
                        <div><strong>Artified</strong></div>
                    </div>
                    <div>
                        <div class="gray mb-8 fs-09">Address</div>
                        <div><strong>24B, Madinson garden</strong></div>
                    </div>
                    <div>
                        <div class="gray mb-8 fs-09">Starts</div>
                        <div><strong>03PM</strong></div>
                    </div>
                    <div>
                        <div class="gray mb-8 fs-09">Ends</div>
                        <div><strong>05PM</strong></div>
                    </div>
                </div>
            </div>
            <div>Track</div>
            <div>
                ...
                <div class="flx gap-24">
                    ...
                    <div class="session">
                        ...
                        <span class="text-ellipsis">Dropped off</span>
                    </div>
                </div>
            </div>
        </div>
