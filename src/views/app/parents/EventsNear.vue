        ...
        <div class="title-row flx gap-24 ai-c">
            <div class="flx gap-8 search-row">
                <div class="secondary-input-wrapper input-wrapper" id="search_radius_wrapper">
                    <label for="searchRadiusInput" id="radius"></label>
                ...
                <div class="secondary-input-wrapper input-wrapper" :class="{'show-err' : noInput}" id="location_search_wrapper">
                    <label for="locationSearchInput">Enter zipcode</label>
                    <i>
            ...
            <button @click="fetchNearByEvents" class="button-secondary gap-8 btn-lg fw-500 my-location-btn">
