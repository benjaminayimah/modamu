<template>
    <div class="flx column gap-40 jc-c bg-white ai-c br-24">
        <div class="flx jc-c">
            <completed-anime v-if="getNewUser.completed" />
            <svg id="kids" v-else-if="getNewUser.kids.length == 0" xmlns="http://www.w3.org/2000/svg" height="130" viewBox="0 0 194.5 143">
